...
La chiptune classica, è un termine ombrello che copre una vasta gamma di stili e mentalità che non vogliamo abbracciare per queste ragioni:

- Il sound design è la cosa più importante, la maggior parte degli artisti di chiptune non si concentra su di esso.
- Coverizzare un brano su un tracker è un gesto sterile, la cui mera meccanicità uccide il flusso compositivo, spesso nel farlo si omette di contaminare il brano con del gusto personale.

Per questo si sceglie di sintetizzare tutto ciò che esula dal blip-blop, di abbracciare il glitch in ogni sua forma per garantire
al vecchio hardware di non suonare più retrogrado, di avere un nuovo suono
